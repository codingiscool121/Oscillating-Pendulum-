...
function draw() {
  ...
  text("Click Space to control oscillation with mouse",70,20)
  text("Click Left/Right arrow key to start natural oscillation",70,50);
  text("Press Enter to stop the Pendulum from oscillating",70,80);
